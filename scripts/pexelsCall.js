...
function makePexelsCall(endpoint, query, orientation, color) {
    fetch(endpoint, {
        headers: {
        ...
        .then(result => {
            ...
            result.photos.forEach((photo, index) => {
                ...
                <div class="mdc-card__media mdc-card__media--square"
                    style="background: url(${photo.src.original}); background-repeat: no-repeat; background-size: cover; ">
                </div>
            ...
            <div class="mdc-card__actions">
                <div class="mdc-card__action-buttons">
                    <button class="mdc-button mdc-card__action mdc-card__action--button" id="save-img-${index}" data-content="${photo.src.medium}" data-content-color="${color.split('color=')[1]}" data-content-orientation="${orientation}" data-content-query="${query}">
             ...
             <button class="mdc-button mdc-card__action mdc-card__action--button">
                 ...
                 <span class="material-symbols-outlined" style="margin-right: 4px;">
                    ...
                    <span class="mdc-button__label">${JSON.stringify(photo.photographer_id).substr(0, 3)}</span>
                            ...
                            <ul class="mdc-list mdc-list--avatar-list">
                                ...
                                <li class="mdc-list-item" tabindex="0" data-mdc-dialog-action="none">
                                    <button class="mdc-button mdc-button--outlined mdc-button--share" id="copy-img-url-${index}" >
                                        ...
                                        <!-- Use icons -->
                                        <span class="mdc-button__label" style="display:flex; " id="url-${index}" data-content="${photo.url}"><span class="material-symbols-outlined">
                                        content_copy
                                        </span>Copy URL</span>
                                    </button>
                                </li>
